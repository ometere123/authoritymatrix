...
def main():
    ...
    require("def action_binding_hash(" in source, "description/action/context/matrix commitment helper exists")
    require("expected_description_hash" in source and "expected_binding_hash" in source, "authorization view checks description binding")
    require("action_binding_hash(" in consumer and "expected_binding_hash" in consumer, "consumer independently recomputes description binding")
    require("test_consumer_description_binding_rejects_a_different_payload_description" in tests, "description/action substitution regression exists")
